...
export type Layer = "backplot" | "toolpath" | "machine" | "bounds" | "toolpathBounds" | "workzero" | "hud" | "surface" | "tool" | "groundGrid";
export const ALL_LAYERS: Layer[] = ["backplot", "toolpath", "machine", "bounds", "toolpathBounds", "workzero", "hud", "surface", "tool", "groundGrid"];
...
const VIEWER_FALLBACK: ViewerDefaults = {
  layers: { backplot: true, toolpath: true, machine: true, bounds: true, toolpathBounds: false, workzero: true, hud: true, surface: true, tool: true, groundGrid: true },
