...
// Oracle: LinuxCNC v2.9.4 trtfuncs.c/kins_util.c + master@493926b56c
// xyzacb_trsrn.comp compiled via scripts/kins_oracle/ (see its README
// for provenance). Seed 0x5c1a5.
...
export const TRSRN_KINS_FIXTURES: TrsrnFixtureSet[] = [
 {
  ...
  "params": {
   ...
   "toolOffset": 100.0,
   "preRot": -1.781762,
   "primaryAngle": 130.2455,
   "secondaryAngle": -40.8555
  },
  "forward": [
   {
    "input": [
