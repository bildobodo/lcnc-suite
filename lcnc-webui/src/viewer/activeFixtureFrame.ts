...
// identity/TCP kinematics the fixture numbers ARE table-frame coordinates
// (TCP's world frame rides the table; identity coincides with it at the A=0
// datum the fixtures are stored at), so the triad sits at
